...
VALUES
    ('admin@learninghub.edu.vn', '$2a$10$GW9Yqf8hURrioCQDeh/gR.D6gjJBizVdlgh2mB/8CyjbjXudcaSZm', 'Quản trị hệ thống', DATE '1990-01-01', 'ADMIN', NULL, NULL, 'Phòng đào tạo', NULL, FALSE, 'ACTIVE', NULL),
    ('gv.nguyenvana@learninghub.edu.vn', '$2a$10$GW9Yqf8hURrioCQDeh/gR.D6gjJBizVdlgh2mB/8CyjbjXudcaSZm', 'Nguyễn Văn An', DATE '1984-03-12', 'LECTURER', NULL, 'GV001', 'Công nghệ thông tin', 'Kỹ thuật phần mềm', FALSE, 'ACTIVE', NULL),
    ('gv.tranthib@learninghub.edu.vn', '$2a$10$GW9Yqf8hURrioCQDeh/gR.D6gjJBizVdlgh2mB/8CyjbjXudcaSZm', 'Trần Thị Bình', DATE '1988-09-20', 'LECTURER', NULL, 'GV002', 'Công nghệ thông tin', 'Hệ thống thông tin', FALSE, 'ACTIVE', NULL),
    ('gv.leminhc@learninghub.edu.vn', '$2a$10$GW9Yqf8hURrioCQDeh/gR.D6gjJBizVdlgh2mB/8CyjbjXudcaSZm', 'Lê Minh Cường', DATE '1982-11-05', 'LECTURER', NULL, 'GV003', 'Quản trị kinh doanh', 'Marketing', FALSE, 'ACTIVE', NULL),
    ('sv20240001@student.edu.vn', '$2a$10$GW9Yqf8hURrioCQDeh/gR.D6gjJBizVdlgh2mB/8CyjbjXudcaSZm', 'Phạm Hoàng Nam', DATE '2006-02-14', 'STUDENT', 'SV20240001', NULL, 'Công nghệ thông tin', 'Kỹ thuật phần mềm', TRUE, 'ACTIVE', (SELECT id FROM administrative_classes WHERE class_name = 'CNTT-K65A')),
    ('sv20240002@student.edu.vn', '$2a$10$GW9Yqf8hURrioCQDeh/gR.D6gjJBizVdlgh2mB/8CyjbjXudcaSZm', 'Đỗ Minh Anh', DATE '2006-06-22', 'STUDENT', 'SV20240002', NULL, 'Công nghệ thông tin', 'Kỹ thuật phần mềm', TRUE, 'ACTIVE', (SELECT id FROM administrative_classes WHERE class_name = 'CNTT-K65A')),
    ('sv20240003@student.edu.vn', '$2a$10$GW9Yqf8hURrioCQDeh/gR.D6gjJBizVdlgh2mB/8CyjbjXudcaSZm', 'Nguyễn Thùy Linh', DATE '2006-10-09', 'STUDENT', 'SV20240003', NULL, 'Công nghệ thông tin', 'Hệ thống thông tin', TRUE, 'ACTIVE', (SELECT id FROM administrative_classes WHERE class_name = 'CNTT-K65B')),
    ('sv20240004@student.edu.vn', '$2a$10$GW9Yqf8hURrioCQDeh/gR.D6gjJBizVdlgh2mB/8CyjbjXudcaSZm', 'Trần Quốc Huy', DATE '2005-12-01', 'STUDENT', 'SV20240004', NULL, 'Công nghệ thông tin', 'Hệ thống thông tin', TRUE, 'ACTIVE', (SELECT id FROM administrative_classes WHERE class_name = 'CNTT-K65B')),
    ('sv20240005@student.edu.vn', '$2a$10$GW9Yqf8hURrioCQDeh/gR.D6gjJBizVdlgh2mB/8CyjbjXudcaSZm', 'Vũ Ngọc Mai', DATE '2006-04-18', 'STUDENT', 'SV20240005', NULL, 'Quản trị kinh doanh', 'Marketing', TRUE, 'ACTIVE', (SELECT id FROM administrative_classes WHERE class_name = 'QTKD-K65A')),
    ('sv20240006@student.edu.vn', '$2a$10$GW9Yqf8hURrioCQDeh/gR.D6gjJBizVdlgh2mB/8CyjbjXudcaSZm', 'Hoàng Gia Bảo', DATE '2006-08-30', 'STUDENT', 'SV20240006', NULL, 'Quản trị kinh doanh', 'Marketing', TRUE, 'ACTIVE', (SELECT id FROM administrative_classes WHERE class_name = 'QTKD-K65A')),
    ('sv20240007@student.edu.vn', '$2a$10$GW9Yqf8hURrioCQDeh/gR.D6gjJBizVdlgh2mB/8CyjbjXudcaSZm', 'Bùi Khánh Vy', DATE '2006-01-25', 'STUDENT', 'SV20240007', NULL, 'Công nghệ thông tin', 'Kỹ thuật phần mềm', TRUE, 'ACTIVE', (SELECT id FROM administrative_classes WHERE class_name = 'CNTT-K65A')),
    ('sv20240008@student.edu.vn', '$2a$10$GW9Yqf8hURrioCQDeh/gR.D6gjJBizVdlgh2mB/8CyjbjXudcaSZm', 'Lê Đức Phúc', DATE '2005-07-11', 'STUDENT', 'SV20240008', NULL, 'Công nghệ thông tin', 'Hệ thống thông tin', TRUE, 'INACTIVE', (SELECT id FROM administrative_classes WHERE class_name = 'CNTT-K65B'))
